...
<div class="card p-4 shadow border-0 mb-4">
    <div class="card-header">
        <h5><i class="fas fa-file"></i> Form Edit Data Supplier</h5>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-8">
                <form action="/supplier" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="nama_lengkap" class="col-3">Nama Supplier</label>
                        <div class="col-9">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-9">
                            <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="5">{{ old('alamat') ?? $supplier->alamat}}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
